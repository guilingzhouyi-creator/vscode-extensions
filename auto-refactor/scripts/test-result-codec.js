/**
 * Module: Verification Harness — Result Codec Round-Trip Gate
      ...
      issues: [
        {
          ...
          rule: 'y',
          severity: 'info',
          message: '中文注释 i18n 字面量 non-ASCII ✓',
          location: { file: 'b.ts', start: { line: 1, column: 2 }, end: { line: 1, column: 2 } },
          detail: {
            value: '中文',
            list: [1, 2, 3],
            neg: -5,
      ...
      issues: [
        {
          ...
          severity: 'warning',
          message: 'm',
          location: { file: 's.ts', start: { line: 1, column: 1 }, end: { line: 1, column: 1 } },
          detail: {},
        },
      ],
      metric: null,
