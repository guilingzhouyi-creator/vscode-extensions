 ...
 */
function checkCrossDomainBypass(
    file: ArchitecturalFileInfo,
    issues: Issue[],
    flagBypass: boolean,
): void {
 ...
 */
function checkMutableGlobalCoupling(
    file: ArchitecturalFileInfo,
    issues: Issue[],
    flagGlobal: boolean,
): void {
 ...
 */
function checkLayeringIllusion(
    file: ArchitecturalFileInfo,
    issues: Issue[],
