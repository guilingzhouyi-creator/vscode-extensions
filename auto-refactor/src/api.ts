...
export * from './core/scoring/autonomy-scorer';
export * from './core/intelligence/dependency-provenance';
export { printAutonomyAssessment } from './core/reporting/quality-printer';
