...
export declare class CommandRegistrar {
    ...
    register(context: vscode.ExtensionContext, orchestrator: TimerOrchestrator | null, statusBar: StatusBarController | null, storage: StorageCoordinator | null, globalAggregator: GlobalAggregator | null): void;
